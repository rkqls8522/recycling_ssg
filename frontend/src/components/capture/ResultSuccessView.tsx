    ...
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="bg-primary text-primary-foreground px-5 pt-12 pb-4">
        <div className="flex items-center justify-between mb-4">
          <div className="w-9" />
          {/* Flow indicator — step 2 (result: success) */}
              ...
              <div key={i} className="flex items-center">
                <div className="flex flex-col items-center gap-0.5">
                  ...
                  <span className={`text-[9px] font-semibold ${
                    i === 2 ? "text-primary-foreground" : "text-primary-foreground/50"
                  }`}>{label}</span>
                </div>
                {i < 2 && <div className="w-8 h-px mx-1 mb-3 bg-primary-foreground/40" />}
              </div>
            ))}
          </div>
          <div className="w-9" />
