        ...
        <div className="relative">
          <div
            className={`relative rounded-2xl overflow-hidden bg-muted flex items-center justify-center transition-all ${
              previewUrl ? "border-2 border-primary" : "border-2 border-dashed border-border"
            }`}
            style={{ minHeight: 260 }}
          >
            {previewUrl ? (
              ...
              >
                ...
                <div className="w-16 h-16 rounded-2xl bg-muted-foreground/10 flex items-center justify-center mb-3">
                  <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8 text-muted-foreground" aria-hidden="true">
                ...
                <p className="text-sm font-semibold text-foreground">탭하여 촬영</p>
                <p className="text-xs text-muted-foreground mt-0.5 text-center">또는 하단에서 갤러리 선택</p>
              </div>
            )}
          </div>
        </div>
